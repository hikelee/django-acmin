# Generated by Django 2.1.3 on 2018-12-25 18:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(max_length=10, null=True, verbose_name='数据类型')),
                ('max_length', models.IntegerField(null=True, verbose_name='最大长度')),
                ('serialize', models.BooleanField(null=True, verbose_name='可序列化')),
                ('help_text', models.TextField(null=True, verbose_name='帮助文本')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verbose_name', models.CharField(max_length=100, verbose_name='描述')),
                ('sequence', models.IntegerField(default=100, verbose_name='排序')),
                ('conenttype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.ContentType')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.Group')),
            ],
            options={
                'verbose_name': '模型(用户组)',
