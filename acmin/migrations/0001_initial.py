...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attribute', models.CharField(max_length=100, verbose_name='字段属性')),
                ('group_sequence', models.IntegerField(verbose_name='分组序号')),
                ('sequence', models.IntegerField(verbose_name='序号')),
                ('list_available', models.BooleanField(default=True, verbose_name='列表中显示')),
                ('form_available', models.BooleanField(default=True, verbose_name='表单中显示')),
                ('verbose_name', models.CharField(max_length=200, verbose_name='显示名称')),
                ('base', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='field_base', to='acmin.ContentType', verbose_name='模型')),
                ('contenttype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.ContentType', verbose_name='字段模型')),
            ],
            options={
                'verbose_name': '字段',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_available', models.BooleanField(default=True, verbose_name='表单中显示')),
                ('verbose_name', models.CharField(max_length=200, verbose_name='显示名称')),
                ('base', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_field_base', to='acmin.ContentType', verbose_name='模型')),
                ('contenttype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.ContentType', verbose_name='字段模型')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.Group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_available', models.BooleanField(default=True, verbose_name='表单中显示')),
                ('verbose_name', models.CharField(max_length=200, verbose_name='显示名称')),
                ('base', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_field_base', to='acmin.ContentType', verbose_name='模型')),
                ('contenttype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.ContentType', verbose_name='字段模型')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
