...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field_attribute', models.CharField(max_length=100, verbose_name='字段名称')),
                ('field_contenttype', models.CharField(blank=True, max_length=100, null=True, verbose_name='字段模型')),
                ...
                ('base', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='acmin.ContentType', verbose_name='模型')),
            ],
            options={
                'verbose_name': '字段',
